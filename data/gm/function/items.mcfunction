...
#give @s lime_stained_glass_pane[custom_data={gui:{"item":"holder","cached":false,"safe":1b}},item_name='"Item Holder"',lore=['{"color":"gold","italic":false,"shadow_color":16750848,"text":"[UNCACHED]"}','{"color":"#FFFF05","text":"\\n Allows Item Inputs"}']] 1
give @s lime_stained_glass_pane[custom_data={gui:{"item":"holder","cached":true,"safe":1b}},item_name='"Item Holder"',lore=['{"italic":false,"color":"gold","text":"[CACHED]"}','{"color":"#FFFF05","text":"\\n Allows Item Inputs"}']] 1

#> Toggle Button (Clicking it Changes Button Icon)
#give @s brown_stained_glass_pane[item_name='"Toggle Button"',lore=['{"color":"gold","italic":false,"text":"[UNCACHED]"}','{"color":"#FFFF05","text":"\\n Cycle through Items"}'],custom_data={gui:{"item":"toggle_button","cached":false,"safe":1b}}] 1
give @s brown_stained_glass_pane[item_name='"Toggle Button"',lore=['{"color":"gold","italic":false,"text":"[CACHED]"}','{"color":"#FFFF05","text":"\\n Cycle through Items"}'],custom_data={gui:{"item":"toggle_button","cached":true,"safe":1b}}] 1

#> Data-Driven Button (Displays Item from a Storage)
give @s pink_stained_glass_pane[item_name='"Data Driven Item-Button"',lore=['{"color":"#FFFF05","text":"\\n Insert Buttons from Storages"}'],custom_data={gui:{item:"data_driven_button","safe":1b}}] 1
